...
export const capabilities: Capability[] = [
  {
    ...
    demoNote:
      "会社ロゴや基本形状をWebGLでリアルタイム描画します。実案件では、目的とご用意できる素材に合わせて、CAD / glTFや3Dスキャンを使った製品モデルに差し替えられます。",
    howToUse: [
      "形状・素材・カラーをリアルタイムWebGLで変更",
      "ドラッグで回転、ホイールやピンチで拡大・縮小",
      "自動回転と視点リセットで形状を確認できます",
    ],
  },
  {
    slug: "configurator",
