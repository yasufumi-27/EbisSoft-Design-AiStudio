...
export const strengths: Strength[] = [
  ...
  },
  {
    title: "表示速度を計測して改善",
    description:
      "AIで浮いた時間を品質の改善に使います。Lighthouseで表示速度・アクセシビリティ・SEOを確認し、端末や通信条件に応じた課題を継続して改善します。",
    icon: "gauge",
  },
  {
...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "落ちません。AIは「量産できる工程」を担当し、設計方針・ブランド表現の判断・コードレビュー・公開判断は必ず人が行います。AIで浮いた時間を品質に再投資できるため、むしろ作り込みは深くなります。当サイトもLighthouseなどで確認し、表示速度・アクセシビリティの課題を継続して改善しています。",
    category: "ai",
  },
  {
